...
// come back and redo this one with a mentor. is there another way to write this?
  //Code Here
for (var key in user ) {
  if (!(user[key])) {
    delete user[key]
...
//Once you get your truthy Object, Change the remaining values in the object to be specific to you (name: 'your name', username: 'your username'), rather than my information.
  ...
  //Code Here
user.name = "ladd";
user.pwHash = "slkjfnvds";
user.username = "laddmauigoa";
...
methodCollection.logHello(message);
...
var user2  = {
    name: "ladd Mauigoa",
    email: "laddmauigoa@gmail.com",
    password: "ilovedogs",
    username: "laddy"
}
var user3  = {
    name: "eddie mauigoa",
    email: "eddiemauigoa@gmail.com",
    password: "ilovecats",
    username: "eddiespaghetti"
}
